...
@ScriptManifest(authors={"Durka Durka Mahn, Pirateblanc"}, category="Misc", description="UIPaintTest", version=0.1,name="UIPaintTester")
public class UIPaintTester extends Script implements PaintListener {
