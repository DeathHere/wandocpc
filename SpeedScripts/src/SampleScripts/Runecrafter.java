...
public class Runecrafter extends Script implements PaintListener {
                ...
                if (timeToNext < time()) {
                    if (roll > 995) {
                        ...
                        timeToNext = System.currentTimeMillis()
                            ...
                            && !RSInterface.getInterface(751).getChild(15).getText().contains("Off")) {
                        checkFriendsList();
                        timeToNext = System.currentTimeMillis()
                                + random(2000, 25000);
                        ...
                        if (random(0, 2) == 0) {
                            setCameraRotation((int) (getCameraAngle() + (Math.random() * 50 > 25 ? 1 : -1)
                                    * (30 + Math.random() * 90)));
                        } else {
    ...
    public class GUI extends JFrame {
        ...
        private void initComponents() {
            ...
            jLabel2.setFont(new java.awt.Font("Copperplate Gothic Light", 1,
                    12));
            ...
            layout.setHorizontalGroup(layout.createParallelGroup(
                    ...
                    jCheckBox4).addPreferredGap(
                    javax.swing.LayoutStyle.ComponentPlacement.RELATED,
                    62,
                    Short.MAX_VALUE).addComponent(
                    jCheckBox5)).addComponent(
                    jTextField1,
                    javax.swing.GroupLayout.DEFAULT_SIZE,
                    278,
                    Short.MAX_VALUE).addComponent(
            ...
            layout.setVerticalGroup(layout.createParallelGroup(
                    ...
                    6,
                    javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(
                    javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(jLabel2).addPreferredGap(
                    javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
                    jSlider1,
                    javax.swing.GroupLayout.PREFERRED_SIZE,
                    javax.swing.GroupLayout.DEFAULT_SIZE,
                    ...
                    layout.createParallelGroup(
                    javax.swing.GroupLayout.Alignment.BASELINE).addComponent(
                    jCheckBox4).addComponent(
                    jCheckBox5)).addPreferredGap(
                    javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(
                    jSeparator6,
                    javax.swing.GroupLayout.PREFERRED_SIZE,
                    10,
                    javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(
                    javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(jCheckBox3).addPreferredGap(
                    javax.swing.LayoutStyle.ComponentPlacement.RELATED,
                    javax.swing.GroupLayout.DEFAULT_SIZE,
                    Short.MAX_VALUE).addComponent(
                    jSeparator3,
    ...
    public int loop() {
        switch (action) {
            case WALK_BANK:
                ...
                if (booth != null
                        && pointOnScreen(Calculations.tileToScreen(booth.getLocation()))
                ...
                if (getDestination() == null
                        || booth == null
                        || Methods.distanceBetween(getDestination(), booth.getLocation()) > 3) {
                    walkPath(BankPath);
                }
                break;
            ...
            case EXIT_ALTAR:
                ...
                if (!getMyPlayer().isMoving()) {
                    if (tileOnScreen(getNearestObjectByID(Runecrafter.Portals).getLocation())) {
                        click(getNearestObjectByID(Runecrafter.Portals).getLocation(), "Enter");
                        if (waitToMove(1200)) {
                            while (getMyPlayer().isMoving()) {
                                Antiban.run();
                            }
                        ...
                        walkToTile(getNearestObjectByID(Runecrafter.Portals).getLocation());
                        return random(500, 1000);
                    }
                }
        }
        ...
        if (paint) {
            ...
            if (!lite) {
                ...
                if (getNearestObjectByID(Runecrafter.Banks) != null
                        && (action.equals(Action.WALK_BANK) || action.equals(Action.OPEN_BANK))) {
                    if (tileOnScreen(getNearestObjectByID(Runecrafter.Banks).getLocation())) {
                        overlayTile(g, getNearestObjectByID(Runecrafter.Banks).getLocation(), new Color(255, 255, 0, 75));
                    }
                    if (tileOnMap(getNearestObjectByID(Runecrafter.Banks).getLocation())) {
                        g.setColor(new Color(255, 255, 0, 75));
                        g.fillOval(
                                tileToMinimap(getNearestObjectByID(
                                Runecrafter.Banks).getLocation()).x - 3,
                                tileToMinimap(getNearestObjectByID(
                                Runecrafter.Banks).getLocation()).y - 1, 2, 2);
                    }
                }
                if (getNearestObjectByID(Runecrafter.Portals) != null) {
                    if (tileOnScreen(getNearestObjectByID(Runecrafter.Portals).getLocation())) {
                        overlayTile(g,
                                getNearestObjectByID(Runecrafter.Portals).getLocation(), new Color(255, 255, 0,
                                75));
                    }
                    if (tileOnMap(getNearestObjectByID(Runecrafter.Portals).getLocation())) {
                        g.setColor(new Color(255, 255, 0, 75));
                        g.fillOval(
                                tileToMinimap(getNearestObjectByID(
                                Runecrafter.Portals).getLocation()).x - 3,
                                tileToMinimap(getNearestObjectByID(
                                Runecrafter.Portals).getLocation()).y - 3, 6, 6);
                    }
                }
                    ...
                    if (path != null) {
                        ...
                        if (paths.size() >= 2) {
                            for (int i = 1; i < paths.size(); i++) {
                                final Point pre = tileToMinimap(paths.get(i - 1));
            ...
            g.drawString(
                    "Levels Gained "
                    + (skills.getCurrentSkillLevel(Constants.STAT_RUNECRAFTING) - startLv),
                    x, y += 30);
            g.drawString(
                    "Xp Gained "
                    + (skills.getCurrentSkillExp(Constants.STAT_RUNECRAFTING) - startXp),
                    x, y += 15);
            g.setColor(new Color(0, 0, 0, 75));
            g.fill3DRect(x, y += 28, 254, 12, true);
            g.setColor(new Color(255, 0, 255, 100));
            g.fillRect(x + 2, y + 2, (int) (skills.getPercentToNextLevel(Constants.STAT_RUNECRAFTING) * 2.5),
                    8);
            g.setColor(Color.WHITE);
            g.drawString(
        ...
        if (update) {
            ...
            if (JOptionPane.showConfirmDialog(
                ...
                try {
                    ...
                    url = new URL(
                            "http://www.rczhang.webs.com/Scripts/RunecrafterVersion.txt").openConnection();
                    ...
                    if (Double.parseDouble(in.readLine()) > getVersion()) {
                        ...
                        if (JOptionPane.showConfirmDialog(null,
                            ...
                            if (fc.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
                                ...
                                // set up the IO.
                                url = new URL(
                                        "http://www.rczhang.webs.com/Scripts/Runecrafter.java").openConnection();
