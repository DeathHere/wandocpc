...
@ScriptManifest(authors = {"LightSpeed, Pirateblanc"}, category = "AAATest",
name = "UIPaintTest", version = 1.0, description = "<html><head>"
+ "<style type=\"text/css\">"
+ "body {"
+ "   color: #FFFFFF;"
...
+ "</body>"
+ "</html>")
public class UIPaintTester extends Script implements ServerMessageListener, PaintListener {
